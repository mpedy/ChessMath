...
class Gioco12b {
    ...
    start() {
        ...
        maketimer.stopTimerFunction = function () {
            ...
            document.getElementById("ricomincia").setAttribute("disabled", true);
        ...
        window.goal_reached = function () {
            ...
            window.myconfirm_2b("Obiettivo raggiunto", "Hai percorso " + number_of_moves + " mosse. Vuoi riprovare?", "sì", "no",
                function () {
                    $(this).dialog("close");
                    window.ricomincia()
                    $(this).remove();
